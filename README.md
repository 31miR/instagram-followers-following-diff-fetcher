...
not your own.
Last but not least, most of the cookies/headers sent have been copied from the browser (with exception of the profile specific cookies) and there is no guarantee that they will be invalid after some time.
## Is it safe?
